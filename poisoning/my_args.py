...
def setup_argparse():
    ...
    parser.add_argument("-li", "--logind", default=0,
                        help='output files will be err{model}{outputind}.txt, train{model}{outputind}.txt, '
                             'test{model}{outputind}.txt')

    # model                        
    parser.add_argument("-m", "--model", default='linreg',
                        choices=['linreg', 'lasso', 'enet', 'ridge'],
                        help="choose linreg for linear regression, lasso for lasso, enet for elastic net, or ridge "
                             "for ridge")
    ...
    parser.add_argument("-i", "--sigma", default=0.9, type=float,
                        help='line search termination lowercase sigma;icml 2015')
